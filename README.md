[中文Readme](https://github.com/besire/Dedicated-Seedbox/blob/main/README-zh.md)
# !! ALERT
BBR v3 is currently unavailable

# Seedbox Installation Script
## Usage
`bash <(wget -qO- https://raw.githubusercontent.com/besire/Dedicated-Seedbox/main/Install.sh) -u <username> -p <password> -c <Cache Size(unit:MiB)> -q <qBittorrent Version> -l <libtorrent Version> -b -v -r -3 -x -o`
#### Options
	1. -u: username 
	2. -p: password
